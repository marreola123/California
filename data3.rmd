...
mob <- get_acs(geography = "county", state = "CA", 
              variables = "B08105B_001", geometry = TRUE) # 

```


This map was created using ggplot and tidycensus. The map is maping  B08105B_001 = Means of Transportation to Work (Black or African American Alone).


```{r echo=FALSE}
ggplot(mob, aes(fill = estimate)) + geom_sf() #This will map varibles.
```
#########################################################################################################################
